...
export default function WritingExam() {
  ...
  useEffect(() => {
    if (!user || !mockData || restoreDoneRef.current) return

    const restore = async () => {
      try {
        const progress = await getMockProgress('cefr_writing', String(id))
        ...
        if (state.activeTask) setActiveTask(state.activeTask)
        if (typeof state.fontSize === 'number') setFontSize(state.fontSize)
        if (typeof state.isDarkMode === 'boolean') setIsDarkMode(state.isDarkMode)
        if (typeof state.leftPanelWidth === 'number') setLeftPanelWidth(state.leftPanelWidth)
        if (typeof state.mobileSplit === 'number') setMobileSplit(state.mobileSplit)
      } catch (error) {
        console.error('Writing progress restore failed:', error)
      } finally {
      ...
      return (
        <div className={`rounded-2xl shadow-xl overflow-hidden transition-colors ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-6">
            <h2 className="text-2xl font-bold">Ã¢Å“ÂÃ¯Â¸Â PART 2</h2>
    ...
    return (
      <div className={`rounded-2xl shadow-xl overflow-hidden transition-colors ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
          <h2 className="text-2xl font-bold">ÄŸÅ¸â€œâ€¹ PART 1</h2>
        ...
        <div className="p-6 space-y-6">
          <div className={`border-l-4 p-4 rounded-lg transition-colors ${isDarkMode ? 'bg-gray-700 border-blue-600' : 'bg-blue-50 border-blue-600'}`}>
            <h3 className={`font-bold mb-2 ${isDarkMode ? 'text-blue-300' : 'text-blue-900'}`}>ÄŸÅ¸â€œÅ’ Scenario Context:</h3>
      ...
      return (
        <div className={`rounded-2xl shadow-xl overflow-hidden transition-colors ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-5">
            <h2 className="text-xl font-bold">Ã¢Å“ÂÃ¯Â¸Â PART 2 - Writing</h2>
          </div>
          <div className="p-5">
            <div className="flex items-center justify-between mb-3">
            ...
            <div className="mt-2 flex justify-end">
              {wordCount(answers.t2) >= 180 && wordCount(answers.t2) <= 200 && (
                <span className="text-sm text-green-600 font-semibold">Ã¢Å“â€œ Within target</span>
              )}
            </div>
          </div>
        </div>
    ...
    return (
      <div className={`rounded-2xl shadow-xl overflow-hidden transition-colors ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-5">
          <h2 className="text-xl font-bold">Ã¢Å“ÂÃ¯Â¸Â PART 1 - Writing</h2>
        </div>
        <div className="p-5">
          {activeTask === 't11' && (
            <div>
      ...
      <div className={`bg-gradient-to-r from-blue-600 to-purple-600 text-white sticky top-0 z-50 shadow-2xl transition-colors ${isDarkMode ? 'from-blue-800 to-purple-800' : ''}`}>
        <div className="max-w-full mx-auto px-6 py-4">
          <div className="flex items-center justify-between gap-4 flex-wrap">
            <div>
              <h1 className="text-3xl font-bold">ğŸ“ Writing Exam</h1>
              ...
              {(isFullMock || part === 1) && (
                <div className={`rounded-2xl shadow-xl overflow-hidden transition-colors sticky top-0 z-20 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                  <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-8">
                    <h2 className="text-3xl font-bold mb-2">ğŸ“‹ PART 1</h2>
                    <p className="text-blue-100">Write two tasks.</p>
                  </div>
                  ...
                  <div className="p-8">
                    ...
                    <div className={`border-l-4 p-6 rounded-lg mb-8 transition-colors ${isDarkMode ? 'bg-gray-700 border-blue-600' : 'bg-blue-50 border-blue-600'}`}>
                      <h3 className={`font-bold mb-3 ${isDarkMode ? 'text-blue-300' : 'text-blue-900'}`}>ğŸ“Œ Scenario Context:</h3>
                      <p className={`leading-relaxed ${isDarkMode ? 'text-gray-300' : 'text-gray-800'}`}>
                        {mockData.task1.scenario}
                      </p>
                    </div>
              ...
              {(isFullMock || part === 2) && (
                <div className={`rounded-2xl shadow-xl overflow-hidden transition-colors sticky top-0 z-20 ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                  <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-8">
                    <h2 className="text-3xl font-bold mb-2">âœï¸ PART 2</h2>
                    <p className="text-purple-100">Write a blog post.</p>
                  </div>
          ...
          >
            <div className="space-y-6 pl-4">
              ...
              {(isFullMock || part === 1) && (
                <div className={`rounded-2xl shadow-xl overflow-hidden transition-colors ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                  <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-6">
                    <h2 className="text-2xl font-bold">âœï¸ PART 1 - Writing</h2>
                  </div>
              ...
              {(isFullMock || part === 2) && (
                <div className={`rounded-2xl shadow-xl overflow-hidden transition-colors ${isDarkMode ? 'bg-gray-800' : 'bg-white'}`}>
                  <div className="bg-gradient-to-r from-purple-600 to-purple-700 text-white p-6">
                    <h2 className="text-2xl font-bold">âœï¸ PART 2 - Writing</h2>
                  </div>
